...
> 实现基线：`43d76c3ccb7271b6b82b1c058c3f879c383ebd22`<br>
> Workspace 版本：`0.1.0`；Rust MSRV：`1.88`；最后验证：`2026-09-22`

本指南面向第一次部署 NetbaIoT 的开发者、设备开发者和业务系统开发者。它以当前代码、测试和配置 schema 为准；若与更早的文档冲突，以本页标注的实现基线为准。
