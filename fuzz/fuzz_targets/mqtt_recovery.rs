...
fuzz_target!(|data: &[u8]| {
    ...
    // Guarantee that mutations reach the v3 record decoder behind valid framing and whole-image
    // integrity rather than spending most runs on the magic/version gate.
